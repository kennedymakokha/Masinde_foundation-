...
const DonnationModal = ({ showModal, setShowModal, }) => {
    ...
    return (
        <>
            ...
            {showModal ? (
                <>
                    <div className="flex  overflow-x-hidden sm:px-2 fixed sm:top-[13%] top-10 sm:left-[20%] left-2 right-2 sm:right-[10%] z-50 outline-none focus:outline-none">
                        <div className="relative  sm:w-3/4 w-[96%]  my-2 sm:mx-auto mx-2 ">
                            <div className="border-0 rounded-lg  relative flex flex-col  bg-blackmode-200 dark:bg-slate-200 outline-none focus:outline-none">
                                ...
                                <div className="relative px-1 bg-blackmode-100  sm:h-[370px] h-[370px] dark:bg-slate-300 flex-auto">
                                    <div className=" flex flex-col sm:px-8 px-1 sm:py-1 py-0 w-full">
                                        <Title_bare withBrush text="font-semibold text-slate-300 dark:text-blackmode-300 " title="Donate Now" />
                                        <div className="flex   w-full sm:h-10 h-8  my-2  ">
                                        ...
                                        <div className="flex w-full gap-y-2 sm:flex-row flex-col px-2">

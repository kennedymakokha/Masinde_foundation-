...
function index() {
  ...
  return (
    <div className='h-[300px] w-full bg-blackmode-200 flex   sm:px-20 px-2  py-2 '>
      <div className="flex w-1/3 flex-col px-2">
        ...
        <Paraggraph p="Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse inventore facere minus impedit," />
      </div>
        ...
        <div className="flex flex-col ">
          ...
          <div className="sm:flex hidden w-full gap-2 flex-wrap ">
            {images.map((image, i) => (
              ...
              <div className="group w-[100px] h-[100px] relative z-0">
